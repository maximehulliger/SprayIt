...
[CustomEditor( typeof(PaintingInput) )]
[CanEditMultipleObjects]
public class PaintingInputEditor : Editor
{
	//Add the ShowOnEnum methods in here
	private void SetFieldCondition()
	{  
		
		//ShowOnEnum("colorIn","takingFromComputer","true"); //type1Var is only visible when type == Type1
		//ShowOnEnum("brush","Paintbrush","b"); //type2Var is only visible when type == Type2
