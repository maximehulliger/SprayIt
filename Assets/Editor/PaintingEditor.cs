...
public class PaintingEditor : Editor
{
	...
	{  
		//ShowOnEnum("brush","SimpleSpray","sprayProb"); //type1Var is only visible when type == Type1
		//ShowOnEnum("brush","BlendSpray","sprayProb"); 
		//ShowOnEnum("brush","BlendBrush","blendFactor");
		//ShowOnEnum("brush","BlendSpray","blendFactor");
	}
